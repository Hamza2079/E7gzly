    ...
    <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center gap-3 w-full max-w-3xl">
      <div className="relative w-full flex-1">
        ...
        <input 
          ...
          className="w-full pr-10 pl-4 py-3 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
        />
      </div>
      ...
      <div className="flex w-full md:w-auto gap-3">
        <div className="relative w-full md:w-40">
          ...
          <select name="city" defaultValue={searchParams.get("city") || ""} className="w-full pr-9 pl-8 py-3 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-sm appearance-none cursor-pointer">
        ...
        <div className="relative w-full md:w-48">
          <Stethoscope className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
          <select name="spec" defaultValue={searchParams.get("spec") || ""} className="w-full pr-9 pl-8 py-3 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-sm appearance-none cursor-pointer">
